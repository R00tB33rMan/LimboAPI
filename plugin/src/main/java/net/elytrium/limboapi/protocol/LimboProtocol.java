...
public class LimboProtocol {
    ...
    public static void init() throws Throwable {
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x20, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x25, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x52, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x2A, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x36, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x3E, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x58, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x13, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x60, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x50, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
                ...
                createMapping(0x70, ProtocolVersion.MINECRAFT_1_20, true) // 1.20.2
        );
        ...
        register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
                ...
                createMapping(0x17, ProtocolVersion.MINECRAFT_1_20, false) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
                ...
                createMapping(0x16, ProtocolVersion.MINECRAFT_1_20, false) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
                ...
                createMapping(0x18, ProtocolVersion.MINECRAFT_1_20, false) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
                ...
                createMapping(0x19, ProtocolVersion.MINECRAFT_1_20, false) // 1.20.2
        );
        register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
        ...
        register(PLAY_SERVERBOUND_REGISTRY,
                ...
                createMapping(0x06, ProtocolVersion.MINECRAFT_1_20, false) // 1.20.2
        );
    }
